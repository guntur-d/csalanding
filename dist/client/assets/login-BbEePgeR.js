import{m as o}from"./index-CMj6JYxd.js";import{T as i,t as a}from"./index-C128AHEg.js";const l={title:"CSA Login - Chandra Satria Agung",password:"",loading:!1,login:async function(t){var r;if(t.preventDefault(),!this.loading){this.loading=!0;try{(await o.request({method:"POST",url:"/api/auth/login",body:{password:this.password}})).success&&(window.location.href="/admin")}catch(e){a.error(((r=e.response)==null?void 0:r.error)||"Login failed")}finally{this.loading=!1}}},view:function(){return o(".login-layout",{style:`
                background: #111;
                min-height: 100vh;
                display: flex;
                align-items: center;
